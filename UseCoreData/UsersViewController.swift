...
class UsersViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        users = CoreDataManager.sharedManager.getUsers()
...
extension UsersViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let user = CoreDataManager.sharedManager.findUserByEmail(email: myEmail)
    ...
    func deleteAction(at indexPath: IndexPath) -> UIContextualAction {
        ...
        let action = UIContextualAction(style: .destructive, title: "Delete", handler: { _,_,_ in
            ...
            let myEmail = cell.getEmail()
            CoreDataManager.sharedManager.deleteUser(email: myEmail)
